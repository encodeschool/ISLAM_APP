...
import 'package:mosque/providers/auth_provider.dart';
...
import 'package:mosque/providers/learning_provider.dart';
import 'package:mosque/providers/prayer_provider.dart';
import 'package:mosque/providers/qaza_provider.dart';
import 'package:mosque/providers/salah_habit_provider.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => SalahHabitProvider()),
