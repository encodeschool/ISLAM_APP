...
final List<SalahStep> fajrSteps = [

  // ---------- SUNNAH SECTION ----------
  SalahStep(
    type: SalahStepType.info,
    descriptionKey: 'fajr_sunnah_info',
    audience: SalahAudience.maleOnly,
  ),

  SalahStep(
    type: SalahStepType.info,
    descriptionKey: 'fajr_female_sunnah_info',
    audience: SalahAudience.femaleOnly,
  ),
  ...
  SalahStep(
    ...
    audioAssets: {
      "male_hanafi": "'assets/audio/salah/male/02_Takbir.mp3'"
    },
  ),
  ...
  SalahStep(
    ...
    arabicText: '',
    audioAssets: {
      "male_hanafi": 'assets/audio/salah/male/03_Subhanaka+04_Istiaza.mp3'
    },
  ),
  ...
  SalahStep(
    ...
    arabicText: '',
    audioAssets: {
      'male_hanafi': 'assets/audio/salah/male/05_Fatiha+12_Kausar.mp3'
    },
  ),
  ...
  SalahStep(
    ...
    arabicText: '',
    audioAssets: {
      'male_hanafi': 'assets/audio/salah/male/07_Dua ruku.mp3'
    },
  ),
  ...
  SalahStep(
    ...
    arabicText: '',
    audioAssets: {
      'male_hanafi': 'assets/audio/salah/male/08_SamiaLlahu+09_Rabbana.mp3'
    },
  ),
  ...
  SalahStep(
    ...
    arabicText: '',
    audioAssets: {
      'male_hanafi': 'assets/audio/salah/male/10_Dua sudjud.mp3'
    },
  ),
  ...
  SalahStep(
    images: {
      ...
      'female_hanafi': 'assets/images/salah/female/sitting_legs.png'
    },
  ...
  SalahStep(
    ...
    arabicText: '',
    audioAssets: {
      'male_hanafi': 'assets/audio/salah/male/Basmala.mp3'
    },
  ),
  ...
  SalahStep(
    ...
    arabicText: '',
    audioAssets: {
      'male_hanafi': 'assets/audio/salah/male/Fatiha+Ikhlas.mp3'
    },
  ),
  ...
  SalahStep(
    ...
    arabicText: '',
    audioAssets: {
      'male_hanafi': 'assets/audio/salah/male/13_attahiyat+14_Salavat+15_dua attahiyat.mp3'
    },
  ),
  ...
  SalahStep(
    ...
    arabicText: '',
    audioAssets: {
      'male_hanafi': 'assets/audio/salah/male/16_salam.mp3'
    },
  ),
  ...
  SalahStep(
    ...
    arabicText: '',
    audioAssets: {
      'male_hanafi': 'assets/audio/salah/male/17_dua posle namaza.mp3'
    },
  ),
  ...
  // Continue with your existing Farḍ steps
];
