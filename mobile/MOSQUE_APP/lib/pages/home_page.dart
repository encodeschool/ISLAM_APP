...
class _HomePageState extends State<HomePage> {
  ...
  int _currentIndex = 0;
  bool _showTestBanner = false;

  @override
  void initState() {
    super.initState();
    _checkTestModeDialog();
  }

  Future<void> _checkTestModeDialog() async {
    final prefs = await SharedPreferences.getInstance();
    final hasSeenDialog = prefs.getBool('seen_test_dialog') ?? false;
  ...
  void _showTestDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          "This application is currently in test mode.\n\n"
              "Some prayer times, Qibla direction, or data may be inaccurate.",
        ),
        actions: [
          ElevatedButton(
            onPressed: () async {
              final prefs = await SharedPreferences.getInstance();
              await prefs.setBool('seen_test_dialog', true);
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: const SafeArea(
                ...
                child: Center(
                  child: Text(
                    "TEST MODE – Data may be inaccurate",
                    style: TextStyle(
                      color: Colors.white,
